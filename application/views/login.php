...
<head>
  ...
  <title>Login &mdash; Hiroto</title>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome back to <span class="font-weight-bold">Hiroto</span></h4>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Hiroto. Made with 💙 with AhmaadDev
              <div class="mt-2">
